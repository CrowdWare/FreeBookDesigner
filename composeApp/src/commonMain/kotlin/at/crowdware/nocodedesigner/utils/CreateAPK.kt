...
import at.crowdware.freebookdesigner.viewmodel.copyResourceToFile
...
class CreateAPK {
    companion object {
        ...
        fun changeAppId(newId: String, folder: String, name: String) {
            ...
            changeValueInFile(File("$folder${File.separator}out${File.separator}AndroidManifest.xml"), "\"FreeBookBrowser", "\"$name")
        }
